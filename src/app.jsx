...
const icons = [<FaFacebookF />,<FaTwitter/>,<FaLinkedinIn/>,<IoLogoRss />,<FaDribbble/>]
...
const footer1 = ['Help FAQs','Register','Login','My Profile','How It Works?','More About Us'];
const footer2 = ['Our Clients','Partnerships','Blog Entries','Contact Us']
